                      ...
                      <div class="bg-gray-100 flex flex-col mx-auto py-12 sm:px-6 lg:px-8" style="min-height: 100vh;">
                        ...
                        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                                ...
                                <form action="{{ route('auth.registrationconfirm') }}" method="POST" id="wizard-form" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="flex mb-2">
                                          ...
                                          <div class="flex mb-2">
                                            <div class="w-1/2 mr-1">
                                                ...
                                                <input name="phone_number" class="@error('phone_number') is-invalid @enderror  border rounded w-full py-2 px-3 text-grey-darker" id="phone_number" type="number" inputmode="numeric" pattern="[0-9]*" placeholder="+639" value="639" required autocomplete="phone_number">
                                                @error('phone_number')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="step hidden" id="step-3">
                                        <h3 class="text-lg font-semibold mb-2 text-blue-600"> Verification Step </h1>
                                            ...
                                            <div class="flex mb-2">
                                                ...
                                                <div class="w-1/2 ml-1">
                                                    <label class="block text-grey-darker text-sm font-bold mb-2" for="contactperson1number">Contact Person 1 Phone Number</label>
                                                    <input name="contactperson1number"class="@error('contactperson1number') is-invalid @enderror  border rounded w-full py-2 px-3 text-grey-darker" value="{{ old('contactperson1number') }}" id="contacperson1number"  type="number" inputmode="numeric" pattern="[0-9]*"  value="639" required autocomplete="contactperson1number" autofocus>
                                                    @error('contactperson1number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="flex mb-4">
                                                ...
                                                <div class="w-1/2 ml-1">
                                                    <label class="block text-grey-darker text-sm font-bold mb-2" for="contactperson2number">Contact Person 2 Phone Number</label>
                                                    <input name="contactperson2number" class="@error('contactperson2number') is-invalid @enderror  border rounded w-full py-2 px-3 text-grey-darker" value="{{ old('contactperson2number') }}"  id="contacperson2number"  type="number" inputmode="numeric" pattern="[0-9]*"  value="639" required autocomplete="contactperson2number" autofocus>
                                                    @error('contactperson2number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
