...
<body class="bg-cover bg-no-repeat bg-center" style="background-image: url('{{ asset('logo/bgimage6.jpg') }}'); min-height: 100vh;">
  <div class="bg-cover bg-black bg-opacity-75 backdrop-blur-lg" style="min-height: 100vh;">
      <div id="app">
