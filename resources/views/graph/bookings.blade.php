...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Retrieve the labels and booking counts from the server-side
            ...
            var chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Bookings', // Set the label for the dataset
                        data: bookingCounts, // Set the booking counts for the y-axis
                ...
                options: {
                    ...
                    scales: {
                        ...
                        y: {
                            ...
                            title: {
                                display: true,
                                text: 'Number of Bookings' // Customize the y-axis label
                            }
                        }
                    }
                }
